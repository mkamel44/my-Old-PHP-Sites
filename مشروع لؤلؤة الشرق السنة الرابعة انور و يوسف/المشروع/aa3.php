...
<table width="100%" border="0" cellspacing="5" cellpadding="5">
  <tr>
    <td width="28%" align="center" valign="middle" bgcolor="#70786D" class="style435" style="color:#FFFFFF"><div align="center">سعر الطاولة للحجز  <? echo $std->price;  ?> </div></td>
  ...
  <tr>
	...
	<table width="43%" border="0" align="center" cellpadding="2" cellspacing="2" dir="ltr">
  <tr>
    <td width="24%" align="center" valign="middle"><span class="lolo1">
	   ...
	   <script type="text/javascript">
			  $("#add_new").on('click', function (){
			  		...
			  		if($("#card_id").val() != "")
					{
						...
						$("#main_div").load("go3.php",{   booking_date : $("#booking_date").val() , card_id : $("#card_id").val() , department_id :<? echo $std->id;  ?> , price : <? echo $std->price;  ?> ,addGame_Swimming : "done"  });
    ...
    <td width="55%" align="center" valign="middle" class="lolo1">
	<input name="booking_date" type="text" class="lolo2" id="booking_date"  />  
		<script>
			$('#booking_date').datetimeEntry();
		</script>	</td>
    <td width="21%" align="left" valign="middle" class="lolo1">تاريخ الحجز </td>
    </tr>
</table>    </td>
  </tr>
</table>
