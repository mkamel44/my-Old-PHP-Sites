...
<table width="100%" border="0" cellspacing="5" cellpadding="5">
  <tr>
    <td width="28%" align="center" bgcolor="#70786D" class="style435" style="color:#FFFFFF"> <div align="center">سعر الساعة للحجز <? echo $std->price;  ?> </div></td>
  ...
  <tr>
	...
	<table width="65%" border="0" align="center" cellpadding="2" cellspacing="2" dir="ltr">
  <tr>
    <td width="14%" align="center" valign="middle"><span class="lolo1">
      <input name="add_new" type="submit" class="lolo2" id="add_new" value="اضغط للحجز" style="height:20px;width:80px" />
	   <script type="text/javascript">
			  $("#add_new").on('click', function (){
			  		...
			  		if($("#card_id").val() != "")
					{
						if( $("#start").val() != "" && $("#hours").val() != "" )
						{
					
						$("#main_div").load("go1.php",{  start : $("#start").val() , hours : $("#hours").val() , card_id : $("#card_id").val() , department_id :<? echo $std->id;  ?> , price : <? echo $std->price;  ?> ,addPlayGround : "done"  });
    ...
    <td width="20%" align="center" valign="middle" class="lolo1">
	<input name="hours" type="text" class="lolo2" id="hours" style="width:50px;text-align:center;" onkeyup="if(( this.value * 1 ) == ( this.value * 1 )){}else{alert('الرجاء ادخال ارقام فقط');this.value='';}" value="1"  />		</td>
    <td width="13%" align="left" valign="middle" class="lolo1">عدد الساعات </td>
    <td width="39%" align="center" valign="middle" class="lolo1"><input name="start" type="text" class="lolo2" id="start">
        <script>
			$('#start').datetimeEntry();
		</script>    </td>
    <td width="14%" align="left" valign="middle" class="lolo1">من الوقت </td>
    </tr>
</table>
