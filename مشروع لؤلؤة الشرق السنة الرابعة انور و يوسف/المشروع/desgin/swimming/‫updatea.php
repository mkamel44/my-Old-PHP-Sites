...
<table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td width="747" align="right" class="kokoko">      <select name="ids" class="style2" id="ids" style="width:155px" dir="rtl">
        <option value="5" <? echo ($std->id == "5" ?  "selected" : ""); ?>>مسبح اناث</option>
        <option value="6" <? echo ($std->id == "6" ?  "selected" : ""); ?>>مسبح ذكور</option>
        <option value="7" <? echo ($std->id == "7" ?  "selected" : ""); ?>>مسبح عائلات</option>
      </select>   
