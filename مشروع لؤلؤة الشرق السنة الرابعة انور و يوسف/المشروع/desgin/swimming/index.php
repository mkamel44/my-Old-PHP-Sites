...
if($_SESSION["login_cards"] != true  || $_SESSION["login_depa"] != 4)
{
?>
<script language='JavaScript' type='text/JavaScript'>
	window.location='../../cp.php';
...
<tr>
    <td colspan="2" align="center" valign="top" class="style1" style="font-size:50px">المسابح</td>
  </tr>
			...
			<a href="#" id="link4" class="style1">الصور</a>
                <script type="text/javascript">
				   $("#link4").click(function() {
					 $("#main_div").load("showImgs.php",{ a : "2" });
				   }); 
				  </script>
			</td>
          </tr>
