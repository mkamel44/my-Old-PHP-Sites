...
<table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td width="747" align="right" class="kokoko">      <select name="ids" class="style2" id="ids" style="width:155px" dir="rtl">
        <option value="14" <? echo ($std->id == "14" ?  "selected" : ""); ?>>خمسة نجوم مزوج</option>
        <option value="15" <? echo ($std->id == "15" ?  "selected" : ""); ?>>خمسة نجوم مفرد</option>
        <option value="16" <? echo ($std->id == "16" ?  "selected" : ""); ?>>ثلاث نجوم مزوج</option>
        <option value="17" <? echo ($std->id == "17" ?  "selected" : ""); ?>>ثلاث نجوم مفرد</option>
		<option value="18" <? echo ($std->id == "18" ?  "selected" : ""); ?>>نجمة واحدة مزوج</option>
        <option value="19" <? echo ($std->id == "19" ?  "selected" : ""); ?>>نجمة واحدة مفرد</option>
