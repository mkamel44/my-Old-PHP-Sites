...
<table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
      <tr>
        ...
        <td width="199" align="right" valign="top" class="style1">النص</td>
      </tr>
      <tr>
	...
	$("#main_div").load("updateImg.php",{   data : $("#data").val()   ,CardID : <?  echo $CardID;  ?> ,updateCard : "done"  });
