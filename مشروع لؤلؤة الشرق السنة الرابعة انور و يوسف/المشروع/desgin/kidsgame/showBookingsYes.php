...
$products = $db->getGame_SwimmingBookingYes();
...
<table width="100%" border="1" bordercolor="#FF0000" id="example">
  <tr>
		...
		<td width="37%" align="center" valign="middle" class="style1">وقت الحجز </td>
     <td width="27%" align="center" valign="middle" class="style1">اسم الزبون </td>
	    <td width="10%" align="center" valign="middle" class="style1">حضر</td>
		<td width="14%" align="center" valign="middle" class="style1">لم يحضر </td>
  </tr>
    <?
  ...
  <tr>
   <td align="center" dir="rtl"  class="style1"><? 
		...
		echo $sss->customer_name;
		 ?></td>
	<td align="center" class="style1" ><a href="#" val="<? echo $products_one->id; ?>" val1="true" onclick="call_click(this);" class="style2">حضر</a></td>
	<td align="center" class="style1" ><a href="#" val="<? echo $products_one->id; ?>" val1="false" onclick="call_click(this);" class="style2">لم يحضر </a></td>
  </tr>
