...
<table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td width="747" align="right" class="kokoko">      <select name="ids" class="style2" id="ids" style="width:155px" dir="rtl">
        <option value="1" <? echo ($std->id == "1" ?  "selected" : ""); ?>>مراجيح</option>
        <option value="2" <? echo ($std->id == "2" ?  "selected" : ""); ?>>زحليطات</option>
        <option value="3" <? echo ($std->id == "3" ?  "selected" : ""); ?>>سفينة</option>
        <option value="4" <? echo ($std->id == "4" ?  "selected" : ""); ?>>قلابات</option>
      </select>   
