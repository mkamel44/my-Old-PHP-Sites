...
$products = $db->getGame_SwimmingBooking();
...
<table width="100%" border="1" bordercolor="#FF0000" id="example">
  <tr>
  <td width="10%" align="center" valign="middle" class="style1">نوع الحجز</td>
		<td width="39%" align="center" valign="middle" class="style1">وقت الحجز </td>
     <td width="27%" align="center" valign="middle" class="style1">اسم الزبون </td>
	    <td width="10%" align="center" valign="middle" class="style1">الموافقة</td>
