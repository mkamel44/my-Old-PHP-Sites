...
if($_SESSION["login_cards"] != true || $_SESSION["login_depa"] != 2)
{
?>
<script language='JavaScript' type='text/JavaScript'>
	window.location='../../cp.php';
...
<tr>
    <td colspan="2" align="center" valign="top" class="style1" style="font-size:50px">البطاقة الزكية</td>
  </tr>
      ...
      <tr>
        <td><table width="100%" height="185" border="0" cellpadding="2" cellspacing="2">
          <tr>
			...
			<a href="#" id="link1" class="style1">البطاقة الزكية</a>
                <script type="text/javascript">
				   $("#link1").click(function() {
					 $("#main_div").load("showCards.php");
				   }); 
				  </script>
			</td>
          </tr>
