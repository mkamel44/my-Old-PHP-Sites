...
<table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td width="747" align="right" class="kokoko">      <select name="ids" class="style2" id="ids" style="width:155px" dir="rtl">
        <option value="10" <? echo ($std->id == "10" ?  "selected" : ""); ?>>صالة البلياردو</option>
        <option value="11" <? echo ($std->id == "11" ?  "selected" : ""); ?>>كرة القدم</option>
        <option value="12" <? echo ($std->id == "12" ?  "selected" : ""); ?>>كرة السلة</option>
        <option value="13" <? echo ($std->id == "13" ?  "selected" : ""); ?>>بلي ستيشن</option>
      </select>   
