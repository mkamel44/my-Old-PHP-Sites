...
<tr>
    <td colspan="4" align="right" valign="middle" class="style1"> 
	 <input style="width:100px" name="aa3" id="aa3" type="submit" class="style2" value="بضاعة جديد" />
		<script type="text/javascript">
			  $("#aa3").on('click', function (){
			 
					 $("#main_div").load("addSnack.php",{ ShopID : <? echo $ShopID; ?>  });
			  });
			</script>		</td>
</tr>
 
  <tr>
    <td width="76%" align="center" valign="middle" class="style1">اسم البضاعة </td>
 ...
 for($a1=0;$a1<count($products);$a1++)
 {
  ...
  <tr>
	...
	<td align="center" class="style1" ><a href="#" val="<? echo $products_one->snack_id; ?>"  path="<? echo $products_one->snack_pic; ?>" key="deleteSnack.php" onclick="call_click(this);" class="style2">حذف</a></td>
	<td align="center" class="style1" ><a href="#" val="<? echo $products_one->snack_id; ?>" key="‫updateSncks.php" onclick="call_click(this);" class="style2">تعديل</a></td>
  </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" class="style1"><p>لا يوجد بضائع بعد</p>
      <p><input style="width:100px" name="aa333" id="aa333" type="submit" class="style2" value="بضاعة جديد" />
	<script type="text/javascript">
