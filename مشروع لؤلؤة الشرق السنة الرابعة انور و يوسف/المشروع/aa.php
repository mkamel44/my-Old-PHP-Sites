...
<table width="100%" border="0" cellspacing="5" cellpadding="5">
  <tr>
    <td width="28%" align="center" bgcolor="#70786D" class="style435" style="color:#FFFFFF">  <div align="center">سعر البطاقة للحجز <? echo $std->price;  ?></div></td>
  ...
  <tr>
      ...
      <input name="add_new" type="submit" class="lolo2" id="add_new" value="اضغط للحجز" style="height:20px;width:80px" />
	   <script type="text/javascript">
			  $("#add_new").on('click', function (){
			  		...
			  		if($("#card_id").val() != "")
					{
						if($("#num").val() != "" && $("#booking_date").val() != "" )
						{
					
						$("#main_div").load("go.php",{  num : $("#num").val() , booking_date : $("#booking_date").val() , card_id : $("#card_id").val() , department_id :<? echo $std->id;  ?> , price : <? echo $std->price;  ?> ,addGame_Swimming : "done"  });
    ...
    <td align="center" valign="middle" class="lolo1"><input name="num" type="text" class="lolo2" id="num" style="width:50px;text-align:center;" onkeyup="if(( this.value * 1 ) == ( this.value * 1 )){}else{alert('الرجاء ادخال ارقام فقط');this.value='';}" value="1" maxlength="2" /></td>
    <td align="left" valign="middle" class="lolo1">عدد البطاقات </td>
  </tr>
</table>
