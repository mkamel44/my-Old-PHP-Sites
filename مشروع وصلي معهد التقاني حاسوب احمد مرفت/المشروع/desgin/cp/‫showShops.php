...
<table width="100%" border="1" bordercolor="#FF0000" id="example">
 ...
 for($a1=0;$a1<count($products);$a1++)
 {
  ...
  $products_one = $products[$a1];
    ...
    ?>
  <tr>
    <td align="center" dir="rtl"  class="style1"><? echo $products_one->shop_name; ?></td>
	<td align="center" class="style1" ><a href="#" val="<? echo $products_one->shop_id; ?>" key="deleteShop.php" onclick="call_click(this);" class="style2">حذف</a></td>
	<td align="center" class="style1" ><a href="#" val="<? echo $products_one->shop_id; ?>" key="updateShop.php" onclick="call_click(this);" class="style2">تعديل</a></td>
  </tr>
...
function call_click(tag_here)
	{
						...
						if(key == "deleteShop.php")
						{
							 var result = confirm("هل انت متأكد من الحذف؟");
							if (result) {

									$("#main_div").load(key,{ ClintID : val  });
												
							}

						}else
						if(key == "updateShop.php")
						{
