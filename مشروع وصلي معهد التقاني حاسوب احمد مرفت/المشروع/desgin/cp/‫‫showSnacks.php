...
<tr>
    <td colspan="4" align="right" valign="middle" class="style1"><table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tr>
        <td width="50%" align="left">
		  <input style="width:100px" name="aa3" id="aa3" type="submit" class="style2" value="وجبة جديد" />
  ...
  <tr>
    <td width="76%" align="center" valign="middle" class="style1">اسم الوجبة </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" class="style1"><p>لا يوجد وجبات بعد</p>
      <p><input style="width:100px" name="aa333" id="aa333" type="submit" class="style2" value="وجبة جديد" />
	<script type="text/javascript">
