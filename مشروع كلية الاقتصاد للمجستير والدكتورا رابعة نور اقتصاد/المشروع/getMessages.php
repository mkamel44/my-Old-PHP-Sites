...
{
	$msgs = $db_messages->getAllMessagesByTitleOrDate($title,$registration_date);

}
else
if($depa_id != 0)
{
	$msgs = $db_messages->getAllMessagesByDepaID($depa_id);

}
else
{
	$msgs = $db_messages->getAllMessages();
}


?>
<div class="row">
	<div class="col-md-5" align="center" style="padding: 5px">
		<input type="text"  id="title" placeholder="اسم الرسالة......" value="<? echo ($title != "" ? $title : ""); ?>" style="width: 200px" dir="rtl"/>
	</div>
	<div class="col-md-5" align="center" style="padding: 5px">
					...
					$("#dooo").click(function()
						{
							...
							{
								$("#main_div").load("getMessages.php",{ registration_date : $("#registration_date").val() , title : $("#title").val() });
							}
							else
							{
							...
							$("#depa_id").change(function()
								{
									...
									$("#main_div").load("getMessages.php",{depa_id : selectedValue});
