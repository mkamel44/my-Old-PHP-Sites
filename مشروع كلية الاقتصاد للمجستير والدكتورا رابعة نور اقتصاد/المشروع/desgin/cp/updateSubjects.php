...
<div class="box">
	...
	<div class="table">
		...
		if($MembersID != "")
		{
			$std = $db->getSubjectByID($MembersID);
		}
			...
			<tr>
				<td width="53%" valign="top">
					<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
							<td align="right" >
								<input name="name" id="name" dir="rtl"  type="text"  class="field size1" value="<? echo $std->name; ?>" />
							</td>
						...
						$("#addshop2").on('click', function ()
							{
								...
								if($("#name").val() != ""  )
								{
									$("#main_div").load("updateSubjects.php",{  name : $("#name").val(),depa_id : $("#depa_id").val(), MembersID : <? echo $MembersID; ?> , update : "done"  });
