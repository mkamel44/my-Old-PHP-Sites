...
$all_rows_count = $db->getCountMessages();

$products       = $db->getMessages($offset,$row_count);
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				for($a1 = 0;$a1 < count($products);$a1++){
					...
					<tr <? echo (( $a1 % 2 ) ? "class='odd'" : "" ); ?> >
						...
						<td align="center">
							<a href="#" val="<? echo $products_one->id; ?>"  key="deleteMessages.php" onclick="call_click(this);" class="ico del">
								حذف
							</a>
							<a href="#" val="<? echo $products_one->id; ?>" key="updateMessages.php" onclick="call_click(this);" class="ico edit">
								تعديل
							</a>
						</td>
						<td align="center">
				...
				<div class="right">
					...
					<script type="text/javascript">
						$("#perv_").click(function()
							{
								$("#main_div").load("showMessages.php",{ offset  : <? echo $offset_perv; ?> , row_count  : <? echo $row_count; ?> });
							});
					</script>
					...
					<script type="text/javascript">
						$("#next_").click(function()
							{
								$("#main_div").load("showMessages.php",{ offset  : <? echo $offset_next; ?> , row_count  : <? echo $row_count; ?> });
							});
					</script>
				</div>
			</div>
