...
<div class="box">
	...
	<div class="table">
		...
		if($MembersID != "")
		{
			$std = $db->getTheses_DebateByID($MembersID);
		}
							...
							<td align="right" >
								<select name="theses_id" class="field size1" id="theses_id" style="width:200px" dir="rtl">
									...
									for($i = 0;$i < count($aa);$i++)
									{
										$aaa = $aa[$i];
										?>
										<option <? echo ($std->theses_id == $aaa->id ? "selected" : ""); ?> value="<? echo $aaa->id; ?>">
											<? echo $aaa->name; ?>
										</option>
										<?
									}
