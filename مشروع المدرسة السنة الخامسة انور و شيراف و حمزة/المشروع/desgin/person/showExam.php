...
?>
  ...
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr>
	  ...
	  <td width="43%" align="center" class="column">التاريخ</td>
      <td width="45%" align="center" class="column">المادة </td>
...
?>
    ...
    <tr class="row">
      ...
      <td align="center" class="row"><input name="date_of_exam" type="text" class="selectAndText" id="date_of_exam" style="width:130px;text-align:center"  />
	     <script>
			$('#date_of_exam').datetimeEntry({datetimeFormat: 'Y-O-D H:M'});
	   </script> 
	  </td>
      <td align="center"><input name="subjects_name" type="text" class="selectAndText" id="subjects_name" style="width:100px;text-align:center"  /></td>
