...
<option value="<? echo $rtrr->id; ?>"><? echo $rtrr->name; ?></option>
    ...
    <tr>
      <td align="right"><input name="msg_title" type="text" class="selectAndText" id="msg_title"></td>
      <td width="3" align="right" class="tahomaFont">:</td>
      <td width="198" align="right" class="tahomaFont">العنوان</td>
    </tr>
    <tr>
      <td align="right"><textarea name="msg" class="selectAndText" id="msg" style="width:300px;height:100px"></textarea></td>
      <td align="right" class="tahomaFont">:</td>
      <td align="right" class="tahomaFont">نص الرسالة </td>
    </tr>
   
    <tr>
      <td colspan="3" align="center"><input style="width:50px" name="addStudent" type="submit" class="button" value="ارسال"></td>
    </tr>
  </table>
</form>
