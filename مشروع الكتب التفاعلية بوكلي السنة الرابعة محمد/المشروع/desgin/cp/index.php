	...
	<table width="100%" border="1" bordercolor="#FF0000" id="example">
      <tr>
        <td><table width="100%" height="185" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
             <td align="center" valign="middle">
			<a id="link2" href="#" class="style1">الكتّاب</a>
                <script type="text/javascript">
			 $("#link2").click(function() {
			 	$("#main_div").load("‫‫showWriters.php");
			 }); 
			</script>
            </td>
          </tr>
		    <tr>
             <td align="center" valign="middle">
			<a id="link23" href="#" class="style1">الأقسام</a>
                <script type="text/javascript">
			 $("#link23").click(function() {
			 	$("#main_div").load("showDepa.php");
			 }); 
			</script>
            </td>
          </tr>
		   <tr>
             <td align="center" valign="middle">
			<a id="link233" href="#" class="style1">الصفحات</a>
                <script type="text/javascript">
			 $("#link233").click(function() {
