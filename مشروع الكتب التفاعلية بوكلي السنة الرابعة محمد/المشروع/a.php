...
$pass = $pass;//md5(preg_replace('/[^a-zA-Z0-9]/','',$pass));

$name = $name;//md5(preg_replace('/[^a-zA-Z0-9]/','',$name));
  ...
  <table width="0%" height="163" border="1" align="center" cellpadding="2" cellspacing="2">
          <tr>
            <td align="center" valign="top"><table width="392" height="153" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="35" colspan="3" align="center" bgcolor="#FFFFFF"  class="style1 bg-danger btn-lg"><strong>الرجاء   ادخال الاسم وكلمة المرور </strong></td>
              </tr>
              <tr>
